...
- prompt: >
  - look at the env file inside the db capabilities for the database with alembic and fix it. Especially this line: 
  import capabilities.db.models  # noqa: F401  (imports all models and populates Base.metadata)
  - also look at the whole capabilities and fix evertyhing that is not correct so that alembic could run accordingly
  - also change all ondelete="cascade" to ondelete="restrict"
