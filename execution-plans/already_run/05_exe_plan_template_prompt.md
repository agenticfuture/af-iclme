...
- prompt: >
  ...
  import capabilities.db.models  # noqa: F401  
  - perform this: (imports all models and populates Base.metadata), it looks like it's a must for alembic to work accordingly
