...
- prompt: >
  ...
  - now when we click on the finish button when creating the service, it must after configuring and deploying the bot of the service, redirect the page to the playground of that newly created and deployed bot for testing by the tenant
