...
react-server-dom-tur…development.js:3759 Uncaught TypeError: Failed to execute 'measure' on 'Performance': '​ServiceDetailPage' cannot have a negative time stamp.
    at flushComponentPerformance (react-server-dom-tur…elopment.js:3759:35)
    at flushComponentPerformance (react-server-dom-tur…elopment.js:3674:27)
    at flushInitialRenderPerformance (react-server-dom-tur…elopment.js:4120:11)
